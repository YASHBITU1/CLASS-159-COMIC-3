AFRAME.registerComponent("banner", {
    ...
    createBanner: function () {
      posters = {
        ...
        marvel: {
          banner_url: "./assets/marvel banner.jpg",
          title: "Marvel",
          released_year: "1942",
          description:
            "Marvel Comics is a comic book from the Golden Age of Comics, originally published by Helnit Publishing and acquired by Holyoke Publishing in 1942. Issue was published in December 1941, and it ran through issue (August 1946).",
        },
        blackpanther: {
          banner_url: "./assets/black panther banner.jpg",
          title: "Black Panther",
          released_year: "1952",
          description:
